...
{
	public Perturbacao24(Instancia instancia, Config config, HashMap<String, AjusteOmega> configuradoresOmega, int randNum)
	{
		super(instancia, config, configuradoresOmega, randNum);
