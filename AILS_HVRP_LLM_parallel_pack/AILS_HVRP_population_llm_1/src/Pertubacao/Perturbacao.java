...
public abstract class Perturbacao 
{
	...
	int size;
	public HashMap<String, AjusteOmega> configuradoresOmega;
	...
	HashMap<String, AjusteOmega> configuradoresOmega, int randNum)
	{
