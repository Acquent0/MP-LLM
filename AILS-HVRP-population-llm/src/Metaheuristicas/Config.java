...
//		----------------------------Main----------------------------
		...
		this.generation=100;
		this.refDist=0.15;
		this.convergeTimes=5;
		
//		----------------------------Outros----------------------------
		this.stoppingCriterion=StoppingCriterion.Iteration;
	...
	//---------gets and sets-----------
	public double getConevergeTimes() {
		return convergeTimes;
	}
	public void setConevergeTimes(int converge_times) {
		this.convergeTimes = converge_times;
	}
	...
	public int getSubPopSize() {
		return subPopSize;
	}
	public void setSubPopSize(int subPopSize) {
	...
	public void setMuRate(double muRate) {
		this.muRate = muRate;
	}
