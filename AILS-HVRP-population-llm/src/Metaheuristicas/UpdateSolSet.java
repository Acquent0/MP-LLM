...
//         */
//
//        // Cluster-based solution update strategy with weighted scoring mechanism
//
//        double diversityWeight = 0.7; // Weight assigned to diversity in cluster score
//        double fitnessWeight = 0.3; // Weight assigned to fitness in cluster score
//
//        if (gp.numIdv == 0) {
...
//
//            double clusterScore = diversityWeight * clusterDiversity + fitnessWeight * clusterFitness;
...
//         */
//
//        // Cluster-based solution update strategy with equal scoring mechanism
//
//        double diversityWeight = 0.5; // Equal weight assigned to diversity
//        double fitnessWeight = 0.5; // Equal weight assigned to fitness
//
//        if (gp.numIdv == 0) {
//            solSet[gp.numIdv++] = sol;
//            return;
...
public class UpdateSolSet {
    public static void updateSolSet(SolSetParams gp, Solucao[] solSet, Solucao sol, double refDist, BiFunction<Solucao, Solucao, Double> hammingDist, Random rand) {
        ...
        // Multi-criterion strategy incorporating diversity, fitness, and adaptive novelty

        double diversityWeight = 0.3;
        double fitnessWeight = 0.3;
        double noveltyWeight = 0.4; // Begins with a higher weight for novelty
